...
def landscapes():
    mars_img = os.listdir('static/img/landscapes')
    return f"""
            <!DOCTYPE html>
            <html lang="en">
            ...
            <head>
                ...
                <link rel="stylesheet" href="{url_for('static', filename='css/landscapes-page.css')}" type="text/css" >
            ...
            <body>
                ...
                <div id="landscapes" class="carousel slide" data-ride="carousel" data-interval="3000">
                    <ol class="carousel-indicators">
                        <li data-target="#landscapes" data-slide-to="0" class="active"></li>
                        {''.join([f'<li data-target="#landscapes" data-slide-to="{num + 1}"></li>'
                                  for num in range(len(mars_img) - 1)])}
                    </ol>
            
                    <div class="carousel-inner" role="listbox">
                        {''.join([f'''<div class="carousel-item{' active' if i == 0 else ''}">
                                        <img src="{url_for('static', filename=f'/img/landscapes/{file}')}" alt="Изображение" class="center">
                                      </div>'''
                                  for i, file in enumerate(mars_img)])}
                    </div>
            
                    <a class="carousel-control-prev" href="#landscapes" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#landscapes" role="button" data-slide="next">
